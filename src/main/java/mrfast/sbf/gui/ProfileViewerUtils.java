...
public class ProfileViewerUtils {
    ...
    public static void createHotmTree(UIComponent container) {
        ...
        if(hotmNodes.has("mining_fortune")) ProfileViewerGui.miningFortune = hotmNodes.get("mining_fortune").getAsInt();
        if(hotmNodes.has("titanium_insanium")) ProfileViewerGui.tittyInsane = hotmNodes.get("titanium_insanium").getAsInt();
        ...
        if(hotmNodes.has("mining_fortune_2")) ProfileViewerGui.miningFortune2 = hotmNodes.get("mining_fortune_2").getAsInt();
        if(hotmNodes.has("mining_speed_2")) ProfileViewerGui.miningSpeed2 = hotmNodes.get("mining_speed_2").getAsInt();
        if(hotmNodes.has("lonesome_miner")) ProfileViewerGui.lonesomeMiner = hotmNodes.get("lonesome_miner").getAsInt();
        if(hotmNodes.has("fortunate")) ProfileViewerGui.fortunate = hotmNodes.get("fortunate").getAsInt();
        if(hotmNodes.has("great_explorer")) ProfileViewerGui.greatExplorer = hotmNodes.get("great_explorer").getAsInt();
        if(hotmNodes.has("mining_experience")) ProfileViewerGui.seasonMine = hotmNodes.get("mining_experience").getAsInt();
        ...
        if(hotmNodes.has("mining_madness")) ProfileViewerGui.miningMadness = hotmNodes.get("mining_madness").getAsInt();
        if(hotmNodes.has("vein_seeker")) ProfileViewerGui.veinSeeker = hotmNodes.get("vein_seeker").getAsInt();
		if(hotmNodes.has("precision_mining")) ProfileViewerGui.precision = hotmNodes.get("precision_mining").getAsInt();
		...
		if(hotmNodes.has("mining_speed_boost")) ProfileViewerGui.miningSpeedBoost = hotmNodes.get("mining_speed_boost").getAsInt();
