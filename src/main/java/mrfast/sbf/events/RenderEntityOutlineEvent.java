...
public class RenderEntityOutlineEvent extends Event {
     ...
     * Is more efficient (theoretically) than calling {@link #queueEntityToOutline(Entity, Color)} for each entity because lists are handled internally.
     * <p>
    ...
    public void queueEntitiesToOutline(Function<Entity, Integer> outlineColor) {
        ...
        while (itr.hasNext()) {
            Entity e = itr.next();
            Integer c = outlineColor.apply(e);
            if (c != null) {
                entitiesToOutline.put(e, c);
                itr.remove();
            }
        }
    }
     ...
     */
    public void queueEntityToOutline(Entity entity, Color outlineColor) {
        if (entity == null) {
            return;
        }
        if (entitiesToChooseFrom == null) {
        ...
        entitiesToOutline.put(entity, outlineColor.getRGB());
